...
class MessageSenderApp:
    def __init__(self, root):
        ...
        self.button_send_message.grid(row=2, column=1, padx=5, pady=5)
        #Boton enviar archivo
        self.button_send_file = tk.Button(root, text="Enviar archivo", command=self.send_file)
        self.button_send_file.grid(row=2, column=0, padx=5, pady=5)
        ...
        self.text_area.grid(row=3, columnspan=2, padx=5, pady=5)
